 ...
 // You might want to manage state here if you need to handle form submission or input validation
  ...
  const handleSubmit = () => {
    // Here you can handle the submission logic, e.g., calculating amounts, validating inputs, etc.
     ...
     const fpa0 = (document.getElementById('vat-0').checked ? (permonth0 * 0.24) : 0 );
     const foros0 = (document.getElementById('withholding-0').checked ? (permonth0 * 0.20) : 0 );
     ...
     const fpa1 = (document.getElementById('vat-1').checked ? (permonth1 * 0.24) : 0 );
     const foros1 = (document.getElementById('withholding-1').checked ? (permonth1 * 0.20) : 0 );
     ...
     const fpa2 = (document.getElementById('vat-2').checked ?  (permonth2 * 0.24) : 0 );
     const foros2 = (document.getElementById('withholding-2').checked ? (permonth2 * 0.20) : 0 );
     ...
     const fpa3 = (document.getElementById('vat-3').checked ? (permonth3 * 0.24) : 0 );
     const foros3 = (document.getElementById('withholding-3').checked ? (permonth3 * 0.20) : 0 );
     ...
     const fpa4 = (document.getElementById('vat-0').checked ? (permonth4 * 0.24) : 0 );
     const foros4 = (document.getElementById('withholding-4').checked ?  (permonth4 * 0.20) : 0 );
