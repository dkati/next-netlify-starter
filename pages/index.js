 ...
 // You might want to manage state here if you need to handle form submission or input validation
  ...
  const handleSubmit = () => {
    // Here you can handle the submission logic, e.g., calculating amounts, validating inputs, etc.
     ...
     const fpa0 = (document.getElementById('vat-0').checked ? (permonth0 / 1.24) : 0 );
     ...
     const fpa1 = (document.getElementById('vat-1').checked ? (permonth1 / 1.24) : 0 );
     ...
     const fpa2 = (document.getElementById('vat-2').checked ? (permonth2 / 1.24) : 0 );
     ...
     const fpa3 = (document.getElementById('vat-3').checked ? (permonth3 / 1.24) : 0 );
     ...
     const fpa4 = (document.getElementById('vat-0').checked ? (permonth4 / 1.24) : 0 );
